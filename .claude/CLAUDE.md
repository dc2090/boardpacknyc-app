...
- Full-stack implementation (Next.js + Supabase + Prisma)
...
### Phase 5: DATABASE
7. **dba** - Designs and implements database schema (Prisma + Supabase)

### Phase 6: IMPLEMENTATION
8. **frontend-dev** - Implements Next.js frontend with Supabase client integration
9. **backend-dev** - Implements API endpoints, Prisma queries, and business logic
...
8. Ensure Vercel environment variables are set for production
...
- API keys (OpenAI, Stripe, GitHub, Vercel, Linear)
...
- Set as Vercel environment variables for production (via Vercel dashboard or CLI)
...
- ✅ Production-ready Next.js + Supabase + Prisma application
...
- ✅ GitHub repository with automatic Vercel deployments

## OPENAI INTEGRATION

All agents use OpenAI API for AI tasks. Ensure:
- API key is in environment variables (OPENAI_API_KEY)
- Agents use appropriate models for their tasks (GPT-4, GPT-3.5-turbo, etc.)
- Token usage is optimized
- Responses are parsed correctly

## SUPABASE + PRISMA + NEXT.JS STACK
...
- **CI/CD**: Vercel automatic deployments (triggered on git push)
...
- **To dba**: Data models from architecture plan, Prisma schema requirements
- **To frontend-dev**: UI designs, API contracts, Prisma schema, Supabase client setup
- **To backend-dev**: API contracts, business logic requirements, Prisma queries
- **To security-engineer**: Complete codebase for review
- **To qa-engineer**: Implemented features, test scenarios from PRD
- **To devops-engineer**: Tested application, Vercel deployment requirements
